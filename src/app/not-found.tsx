...
export const metadata: Metadata = {
  title: 'ページが見つかりません | citation-reader',
};

/**
 * 404 ブランド統一ページ。Next.js 標準の白ページではなく、ヘッダ + 案内 + トップへ戻る導線を持つ。
 * アプリのトーンに合わせた 404 表示。
 *
 * 注意: このページはアクセスキーゲート (PasswordGate) の外側で表示される
 * (404 は app/page の前段で評価されるため)。意図的に最小限の UI のみで構成し、
 * 内部 API へのリンクや state を持たない。
 */
