// サーバから返されるChatErrorCodeをユーザー向け日本語に変換するマップ。
// 閲覧者が見ても自然で、内部実装の詳細を漏らさない文言に統一する。
//
// 注: SDKや内部例外の生messageはUIに出さない方針
// "raw upstream errors reach UI" / OWASP Improper Error Handling対応)。
